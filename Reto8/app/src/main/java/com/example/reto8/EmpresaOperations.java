...
public class EmpresaOperations {
    ...
    public Empresa getEmpresa(long id) {
        ...
        Empresa empresa = new Empresa(Long.parseLong(cursor.getString(0)),cursor.getString(1),cursor.getString(2),Long.parseLong(cursor.getString(3)),cursor.getString(4),cursor.getString(5), cursor.getString(6));
        // return Employee
        return empresa;
    }
    ...
    public List<Empresa> obtenerTodasEmpresas() {
        ...
        if(cursor.getCount() > 0){
            while(cursor.moveToNext()){
                ...
                empresa.setTelefono(cursor.getLong(cursor.getColumnIndex(EmpresaDBHandler.COLUMN_TELEFONO)));
